...
import com.example.autrackmobile.databinding.ItemContainerRecentConversationBinding;
...
public class RecentConversationsAdapter extends RecyclerView.Adapter<RecentConversationsAdapter.ConversionViewHolder> {
    ...
    class ConversionViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            ...
            binding.textFName.setText(chatMessage.conversationFName);
            binding.textLName.setText(chatMessage.conversationLName);
            binding.textRecentMessage.setText(chatMessage.message);
            binding.getRoot().setOnClickListener(v -> {
                User user = new User();
                user.id = chatMessage.ConversationId;
                user.fname = chatMessage.conversationFName;
    ...
    public Bitmap getConversationImage(String encodedImage) {
